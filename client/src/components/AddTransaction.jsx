...
import { Sparkles, Mic, Camera, Send, Plus, Calendar, Tag, IndianRupee, Ghost, Briefcase, Loader2, X, StopCircle, ArrowDownCircle, ArrowUpCircle } from 'lucide-react';
...
const AddTransaction = () => {
    ...
    const onManualSubmit = (e, forcedType = null) => {
                ...
                <div className="glass p-8 rounded-[2rem] border-white/5 shadow-2xl space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            <button
                                type="button"
                                onClick={() => onManualSubmit(null, 'expense')}
                                className="bg-rose-500 hover:bg-rose-600 text-white font-black py-4 rounded-2xl flex items-center justify-center gap-2 shadow-lg shadow-rose-500/20 active:scale-95 transition-all text-lg"
                            >
                                <ArrowDownCircle className="w-5 h-5" /> Spent
                            </button>
                            <button
                                type="button"
                                onClick={() => onManualSubmit(null, 'income')}
                                className="bg-emerald-500 hover:bg-emerald-600 text-white font-black py-4 rounded-2xl flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20 active:scale-95 transition-all text-lg"
                            >
                                <ArrowUpCircle className="w-5 h-5" /> Earned
                            </button>
                        </div>
                    </div>
                </div>
